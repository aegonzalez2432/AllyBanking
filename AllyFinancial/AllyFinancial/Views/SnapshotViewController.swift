...
class SnapshotViewController: UIViewController {
    lazy var snapshotLabel: UILabel = {
    ...
    init(navigationController: UINavigationController, tabModelType: TabViewModelType) {
        self.tabVM = tabModelType
    ...
    func createUI() {
        ...
        self.view.addSubview(self.snapshotLabel)
//        tab.configView(view: self)
        ...
        self.snapshotLabel.topAnchor.constraint(equalTo: logoutButton.bottomAnchor, constant: 8).isActive = true
        self.snapshotLabel.leadingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.leadingAnchor, constant: 8).isActive = true
        self.snapshotLabel.widthAnchor.constraint(equalToConstant: 150).isActive = true
        self.snapshotLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
    }
